    ...
    <div ref={containerRef} className=" px-[40px] z-0 ">
      <div className="flex flex-col justify-center items-center">
        <div className="flex flex-col gap-[12px] md:gap-[24px]  mx-auto items-center justify-center  max-w-[980px] ">
          <Update />
          <div
            className={`${geistMono.className} text-center lg:text-[112px] md:text-[84px] md:leading-[84px] lg:leading-[112px] md:text- text-[56px] leading-[56px] text-[#001329] animated flex items-baseline justify-around `}
          >
